classdef SpiralsFig7 < handle & mlraut.Spirals
    %% line1
    %  line2
    %  
    %  Created 25-Sep-2025 22:57:43 by jjlee in repository /Users/jjlee/MATLAB-Drive/mlraut/src/+mlraut.
    %  Developed on Matlab 24.2.0.2923080 (R2024b) Update 6 for MACA64.  Copyright 2025 John J. Lee.
    
    methods
        function this = SpiralsFig7(varargin)
            this = this@mlraut.Spirals(varargin{:});
        end

        function [temp1_phase,Vx_flowmap_norm_phase,Vy_flowmap_norm_phase] = task_evoked_unfiltered_fMRI_signal( ...
                this, flagSur,hemisphere,main_folder,~,~,listen_or_answer)
