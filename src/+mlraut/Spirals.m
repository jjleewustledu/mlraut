classdef Spirals < handle & mlsystem.IHandle
    %% line1
    %  line2
    %
    %  Created 20-Sep-2025 19:39:45 by jjlee in repository /Users/jjlee/MATLAB-Drive/mlraut/src/+mlraut.
    ...
    methods
        ...
        function [temp1_compatibility_ratio_pos_nega_real_avg,temp1_compatibility_ratio_pos_nega_sur_avg] = ...
                spiral_detection_surfilt( ...
                this, ...
                subject, ...
                DataIn_smooth, ...
                DataIn_unsmooth, ...
            ...
            elseif flagRest == 1
                spiral_template_filt = zeros(175,251, this.Nt);
            ...
            if flagRest == 1
                if hemisphere == 1
                    folder_name = [main_folder,'/Sample Data/Resting/Spiral Detected'];
                    cd(folder_name)
                ...
                elseif hemisphere == 2
                    folder_name = [main_folder,'/Sample Data/Resting/Spiral Detected'];
                    cd(folder_name)
                    filename = ['Spiral_detected_surfilt_resting_RIGHT_sub',num2str(subject),'.mat'];
                    save([folder_name,'/',filename],'spiral_filt_nega_centreONLY_real','spiral_filt_pos_centreONLY_real','spiral_filt_nega_real','spiral_filt_pos_real','spiral_filt_nega_real_95perc_extend','spiral_filt_pos_real_95perc_extend','spiral_filt_nega_real_centreONLY_95perc_extend','spiral_filt_pos_real_centreONLY_95perc_extend','spiral_template_filt','spiral_size_real_95perc_accu','significant_spiral_radius_avg','significant_spiral_duration_extend','significant_spiral_duration_extend_avg','significant_spiral_frame_kept_ratio','significant_spiral_frame_kept_ratio_extend','expansion_threshold','temp1_compatibility_ratio_pos_nega_real','temp1_compatibility_ratio_pos_nega_sur','temp1_compatibility_ratio_pos_nega_real_avg','temp1_compatibility_ratio_pos_nega_sur_avg','spiral_filt_nega_sur','spiral_filt_pos_sur','-v7.3');
                end
            else
                if flagTask == 1
        ...
        function [spiral_template_timeavg_accu_stdnorm, ...
                spiral_radius_accu_avg, spiral_duration_accu_avg, ...
                spiral_count_timeavg,...
                spiral_transverse_speed_accu_avg] = ...
                spiral_distribution_zscore_map_speed_duration_radius_count( ...
                this, ...
                flagRest, ...
                flagSur, ...
                flagSmooth, ...
            ...
            if flagRest == 1
                spiral_count = zeros(this.Nt, this.Nsub);
            elseif flagRest == 0
            ...
            for subject = 1:this.Nsub
                ...
                if flagRest == 1
                    spiral_template = zeros(176,251,this.Nt);
                    filename = ['Spiral_detected_surfilt_resting_LEFT_sub',num2str(subject),'.mat'] ;
                else
