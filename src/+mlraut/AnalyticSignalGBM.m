        ...
        function this = call_subject(this, s)
            ...
            for t = 1:this.num_tasks
                try
                    ...
                    try
                        physio_gsr_ = ...
                            this.build_global_signal_regressed(this.task_physio(reference=bold_gsr_), is_physio=true);
                        physio_ = ...
                            this.build_band_passed( ...
                    ...
                    if this.do_save_ciftis
                        ...
                        this.write_ciftis( ...
                            ...
                            do_save_dynamic=this.do_save_dynamic);
                        this.write_ciftis( ...
                            this.unwrap(this.analytic_signal_), ...
