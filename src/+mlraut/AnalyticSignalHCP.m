classdef AnalyticSignalHCP < handle & mlraut.AnalyticSignal
    ...
    methods
        ...
        function this = call_subject_late_hilbert(this, s)
            arguments
                this mlraut.AnalyticSignalHCP
                s double
            end
        ...
        function this = call_subject_qc(this, s, t)
            ...
            this.write_ciftis(bold_, "bold-subgs-"+this.global_signal_regression);
             
            % Physio
            physio_ = this.task_physio();
            physio_ = this.build_global_signal_regressed(physio_);
            this.write_nii(physio_, this.source_physio+"-subgs-"+this.global_signal_regression);

            % BOLD for Analytic signal
            psi = this.build_centered(bold_);
            this.write_ciftis(psi, "centered-bold-subgs-"+this.global_signal_regression);
            psi = this.build_rescaled(psi);
            this.write_ciftis(psi, "rescaled-centered-bold-subgs-"+this.global_signal_regression);
            psi = this.build_band_passed(psi);
            this.write_ciftis(psi, "lp"+this.lp_thresh+"-hp"+this.hp_thresh+"-rescaled-centered-bold-subgs-"+this.global_signal_regression);
            psi = hilbert(psi);
            ...
            this.write_nii(phi, "centered-"+this.source_physio+"-subgs-"+this.global_signal_regression);
            phi = this.build_rescaled(phi);
            this.write_nii(phi, "rescaled-centered-"+this.source_physio+"-subgs-"+this.global_signal_regression);
            phi = this.build_band_passed(phi);
            this.write_nii(phi, "lp"+this.lp_thresh+"-hp"+this.hp_thresh+"-rescaled-centered-"+this.source_physio+"-subgs-"+this.global_signal_regression);
            phi = hilbert(phi);
