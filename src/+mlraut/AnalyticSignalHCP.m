            ...
            for t = 1:this.num_tasks     
                try
                    ...
                    if this.do_save_ciftis
                        ...
                        this.write_ciftis( ...
                            abs(this.analytic_signal_).^2, ...
                            sprintf('abs2_as_sub-%s_ses-%s_%s', this.subjects{s}, this.tasks{t}, this.tags), ...
                            do_save_dynamic=this.do_save_dynamic);
                        this.write_ciftis( ...
                    ...
                    if this.do_save_ciftis_of_diffs  % analytic_signal_ - bold_signal_
                        diff_ = (this.analytic_signal_ - this.bold_signal_)./abs(this.analytic_signal_);
                        this.write_ciftis( ...
                            abs(diff_), ...
